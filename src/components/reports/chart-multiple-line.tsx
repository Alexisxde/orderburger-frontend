...
const chartData = [
	...
	{ month: "March", desktop: 237, mobile: 120, tablet: 0 },
	{ month: "April", desktop: 73, mobile: 190, tablet: 80 },
	{ month: "May", desktop: 209, mobile: 130, tablet: 10 },
...
export default function ChartLineMultiple() {
	return (
		<Card>
			<CardHeader>
				<CardTitle className="text-xl">Line Chart - Multiple</CardTitle>
				<CardDescription className="text-sm">
					Resumen de los pagos realizados en los últimos {chartData?.length ?? 6} meses.
				</CardDescription>
			</CardHeader>
			<CardContent>
				...
				<div className="flex w-full items-start gap-2 text-sm">
					<div className="grid gap-2">
						...
						<div className="text-muted-foreground leading-none text-xs">
							Mostrando el total de pedidos con diferentes métodos de pago en los últimos {chartData?.length ?? 6}{" "}
							meses.
						</div>
					</div>
				</div>
